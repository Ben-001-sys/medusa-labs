...
import OrganizationSelectorClient from "../organization-selector/OrganizationSelector.client"
type ItemProps = {
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Gift Options */}
          <div className="mb-3">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-full border hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
              <Checkbox
                checked={isGift}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        ...
                        disabled={
                          giftUpdating || newGiftMessage === giftMessage
                        }
                        className="text-xs px-3 py-1"
                      >
          ...
          <div className="mb-3">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-full border hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
              <Checkbox
                ...
                id="is-instructions"
              />
              <Label htmlFor="is-instructions">Include Instructions</Label>
            </div>
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button
                        ...
                        disabled={
                          ...
                          newInstructions === instructionsMessage
                        }
                        className="text-xs px-3 py-1"
                      >
